...
/// fields, either of which is enough on its own.
        ...
        return Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: Semantics(
                    textField: true,
                    label: AppStrings.manualLatitudeSemanticLabel,
                    child: TextField(
                ...
                Expanded(
                  child: Semantics(
                    textField: true,
                    label: AppStrings.manualLongitudeSemanticLabel,
                    child: TextField(
            ...
            if (state.locationError != null) ...[
              ...
              Text(
                state.locationError!,
                style: const TextStyle(color: AppColors.milestone),
              ),
            ],
          ],
        );
