...
const List<String> settingsCreateStatements = [
  ...
  CREATE TABLE app_settings (
    ...
    iqamath_dhuhr_minutes INTEGER NOT NULL DEFAULT 10,
    iqamath_asr_minutes INTEGER NOT NULL DEFAULT 10,
    iqamath_maghrib_minutes INTEGER NOT NULL DEFAULT 5,
    iqamath_isha_minutes INTEGER NOT NULL DEFAULT 10,
