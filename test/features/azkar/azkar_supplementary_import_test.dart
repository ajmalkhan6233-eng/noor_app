...
void main() {
  ...
  test('populates after_prayer, sleep, and travel with attributed items', () async {
    ...
    expect(await countFor('after_prayer'), 8);
    expect(await countFor('sleep'), 15);
    expect(await countFor('travel'), 1);
